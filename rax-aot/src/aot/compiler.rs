...
use rax_elfgen::elfgen::analyzer::{analyze_elf, AnalyzeElfError};
use rax_elfgen::elfgen::emitter::EmitElfError;
...
mod tests {
    ...
    fn compile_elf_file_with_stats_excludes_jump_table() {
        ...
        let output = std::env::temp_dir().join(format!("rax-aot-stats-{}", std::process::id()));
